...
export class ApiService {
  ...
  searchApproveRequests(search: string, slug: any, page = 1) {
    //for query params
    // return lastValueFrom(this.http.get(`${this.url}/pharmacy/requests/search?`, { params: { page: page, status: "approved", requests_per_page: 10, slug: slug } }));
  ...
  async getEatSummary(slug: any) {
    ...
    // console.log(getRequest.data[0].waiter_phone)
    const payload = {
